...
class Qwen2VLForText2ImgConditionalGeneration(Qwen2VLForConditionalGeneration):
    ...
    def forward(
        ...
        if labels is not None and target_videos is not None:   
            ...
            text_embeddings_gt = self.clip_text_encoder(text_input_ids)[0] # 2,77,768
            cap_loss = self.l2_loss(text_embeddings, text_embeddings_gt).mean()
            ...
            outputs.loss = text_loss + txt2img_loss + cap_loss
